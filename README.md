...
## Summary
A mobile application to Convert between different currency 

## Getting Started
1. Fork and clone from this repository onto your local machine.
```bash
$ git clone https://github.com/devJimmyLam/Currency-Converter-App.git
```
